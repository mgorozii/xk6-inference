...
- `data` (optional): Object where keys are input names and values are data arrays, positional array input, or a Triton/KServe V2 request body with `inputs[].name` and `inputs[].data`. If omitted, dummy data is generated based on model config.
